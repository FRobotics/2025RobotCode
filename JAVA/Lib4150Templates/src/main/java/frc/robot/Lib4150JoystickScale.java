// --------file Lib4150JoystickScale.java
 ...
 * @since      XXXX-XX-XX
*/
public class Lib4150JoystickScale {
    ...
    */
    public Lib4150JoystickScale(  double deadBand, double maxValue, boolean squareInputs ) {
    }
    ...
    */
    public double JoyScaleExec( double rawJoyStickValue ) {
        return 0.0;
    }
